            ...
            <div className="overflow-x-auto">
              ...
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="text-right">AWS Funding</TableHead>
                ...
                {paginatedRankings.map((team, index) => {
                  ...
                  return (
                    <TableRow key={team.id}>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          <TrackIcon track={team.track as 'student' | 'corporate'} size={16} />
                          <span className="capitalize">{team.track}</span>
                        </div>
                      </TableCell>
                      ...
                      <TableCell className="text-right">
                        <div className="flex items-center justify-end gap-1">
                          <span className="text-green-600">{team.aws_funding_upvotes}👍</span>
                          <span className="mx-1">/</span>
                          <span className="text-red-600">{team.aws_funding_downvotes}👎</span>
                        </div>
                      </TableCell>
