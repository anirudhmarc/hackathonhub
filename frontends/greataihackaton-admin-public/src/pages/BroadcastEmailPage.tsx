        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; border: 2px solid #b0b0b0; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); background-color: #ffffff; border-radius: 8px; overflow: hidden;">
          <tr>
            <td align="center" style="padding: 40px 0 30px 0; background-color: #1a1a2e; color: #fff;">
              <h1 style="margin: 0; font-size: 28px; font-weight: bold;">Great Malaysia AI Hackathon</h1>
          ...
          <tr>
            <td style="padding: 20px 30px 40px 30px;">
              ...
              <br/>
              <p style="margin: 0; font-size: 16px; line-height: 24px; color: #333333;">
                Thank you for your valuable support in the Great Malaysia AI Hackathon. Your expertise is crucial to the success of this event.
              </p>
              <br/>
              <p style="margin: 0; font-size: 16px; line-height: 24px; color: #333333;">
              ...
              <p style="margin: 0; font-size: 16px; line-height: 24px; color: #333333;">
                Best regards,<br/>
                Great Malaysia AI Hackathon Team
              </p>
            </td>
          </tr>
          <tr>
            <td align="center" style="padding: 20px 0; background-color: #1a1a2e; color: #e0e0e0; font-size: 14px;">
              &copy; 2025 Great Malaysia AI Hackathon. All rights reserved.
            </td>
          </tr>
        </table>
      </td>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; border: 2px solid #b0b0b0; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); background-color: #ffffff; border-radius: 8px; overflow: hidden;">
          ...
          <tr>
            <td style="padding: 20px 30px 40px 30px;">
              ...
              <br/>
              <p style="margin: 0; font-size: 16px; line-height: 24px; color: #333333;">
                Thank you once again for your dedication during the preliminary round. We are pleased to invite you to serve as a judge for the <strong>Final Round</strong> of the Great Malaysia AI Hackathon! Your continued expertise is highly valued.
              </p>
              <br/>
              <p style="margin: 0; font-size: 16px; line-height: 24px; color: #333333;">
                    ...
                    <tr>
                        <td style="padding: 40px 50px; color: #333333;">
                            <p style="font-size: 16px; line-height: 1.7; margin-top: 0; margin-bottom: 25px;">
                                Dear Great Malaysia AI Hackathon Participant,
                            </p>
                    ...
                    <tr>
                        <td style="background-color: #f7f7f7; padding: 30px 50px; text-align: center; border-top: 1px solid #e0e0e0;">
                            <p style="font-size: 14px; color: #777; margin: 0 0 5px 0;">
                                Thank you for helping us make the Great Malaysia AI Hackathon even better!
                            </p>
                        </td>
                    </tr>
                </table>
...
const BroadcastEmailPage: React.FC = () => {
  ...
  const [templateFormState, setTemplateFormState] = useState({
    emails: '',
    subject: 'Great Malaysia AI Hackathon - Judge Credentials',
    judgeRound: 'preliminary' as 'preliminary' | 'final',
  });

  const [feedbackFormState, setFeedbackFormState] = useState({
    emails: '',
    subject: 'Feedback: [Workshop Title] – Great Malaysia AI Hackathon',
    workshopTitle: '',
  ...
  const handleSendTemplateEmail = async () => {
    ...
    try {
      const emailPromises = emailList.map(async (email) => {
        ...
        return axios.post(`${API_GATEWAY_BASE_URL}/admin/broadcast-email`, {
  ...
  const handleSendFeedbackEmail = async () => {
    ...
    try {
      ...
      await axios.post(`${API_GATEWAY_BASE_URL}/admin/broadcast-email`, {
  ...
  const handleSendEmail = async () => {
    ...
    try {
      const response = await axios.post(`${API_GATEWAY_BASE_URL}/admin/broadcast-email`, payload, {
        headers: {
          'Authorization': `Bearer ${idToken}`,
          'Content-Type': 'application/json',
        },
              ...
              <div className="grid gap-4">
                ...
                <div className="grid w-full items-center gap-1.5">
                  ...
                  <Input
                    ...
                    placeholder="Great Malaysia AI Hackathon - Judge Credentials"
                  />
                </div>
                <div className="grid w-full items-center gap-1.5">
              ...
              <div className="grid gap-4">
                <div className="grid w-full items-center gap-1.5">
                  ...
                  <Input
                    ...
                    placeholder="Feedback: [Workshop Title] – Great Malaysia AI Hackathon"
                  />
                </div>
