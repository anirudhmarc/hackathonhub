...
const EnhancedResultsPage: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen bg-slate-900 text-white overflow-hidden ${isFullscreen ? 'p-0' : 'p-4'}`}>
        ...
        {viewMode === 'overview' && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredRankings.slice(0, 12).map((team) => (
              <Card key={team.id} className={`${getRankColor(team.rank)} transform hover:scale-105 transition-all duration-300`}>
        ...
        {viewMode === 'podium' && (
          <div className="text-center">
            ...
            {filteredRankings[currentSlide] && (
              <Card className={`max-w-2xl mx-auto ${getRankColor(filteredRankings[currentSlide].rank)} transform scale-110`}>
