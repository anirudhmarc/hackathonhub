...
const VideoSubmissionPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!user?.teamId || !user?.problemId) {
      toast({ title: "Requirements Not Met", description: "Please register a team and select a problem statement first.", variant: "destructive" });
      return;
    }
  ...
  const renderContent = () => {
    ...
    if (!user || !user.teamId || !user.problemId) {
        return (
            <Card className="transition-all duration-300 hover:shadow-lg hover:scale-[1.02] animate-in fade-in-50 duration-500">
                <CardContent className="p-12">
                    <div className="flex flex-col items-center justify-center text-center animate-in fade-in-0 slide-in-from-bottom-8 duration-500">
                        ...
                        <h3 className="text-xl font-bold mb-2 transition-colors duration-200 hover:text-primary">Problem Selection Required</h3>
                        ...
                        <Button asChild className="transition-all duration-200 hover:scale-105 hover:shadow-md">
                            <Link to="/dashboard">Select Problem</Link>
                        </Button>
                    </div>
                </CardContent>
            </Card>
                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        <div className="bg-amber-50 p-4 border border-amber-200 rounded-md text-amber-800 text-left max-w-lg">
                            ...
                            <p className="text-sm mb-2">
                                ...
                                Please contact the committee via <a href="https://discord.gg/cNBzRBSr" className="underline font-medium">Discord</a> with
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2 group">
                  ...
                  >
                      ...
                      <>
                        <div className="mb-4 animate-in fade-in-50 slide-in-from-bottom-4 duration-300">
                          ...
                          <p className="text-xs text-muted-foreground transition-all duration-200 group-hover:text-foreground/70">
                            Supported formats: MP4, WebM, AVI, MOV, WMV, MKV, etc. (Maximum size: 500MB, Maximum duration: 10 minutes)
                          </p>
                          <p className="text-xs text-amber-600 mt-1 transition-all duration-200 hover:text-amber-500">
                            💡 For best compatibility across all browsers, use MP4 format
                          </p>
                        </div>
                        <Button
                          type="button"
                    ...
                    <input
                      id="video-upload"
                      type="file"
                      accept="video/*,.mp4,.webm,.avi,.mov,.wmv,.mkv,.flv,.3gp,.m4v,.ogv,.ogg,.mpg,.mpeg,.mts,.m2ts,.ts,.vob,.rm,.rmvb,.asf,.f4v,.divx,.xvid"
                ...
                <div className="space-y-2 group">
                  ...
                  <p className="text-sm text-muted-foreground transition-colors duration-200 group-hover:text-foreground/80">
                    Provide your GitHub or GitLab URL (organization, user profile, or specific repository). Make sure it's <strong className="transition-colors duration-200 group-hover:text-primary">public</strong> so judges can access it.
                  </p>
                </div>

                <div className="space-y-2 group">
                  <Label htmlFor="description" className="transition-colors duration-200 group-hover:text-primary">Project Description *</Label>
                  {user?.track === 'corporate' && (
                    <div className="bg-blue-50 border border-blue-200 rounded-md p-3 mb-4 transition-all duration-300 hover:bg-blue-100 hover:border-blue-300 hover:shadow-md">
                      <p className="text-sm text-blue-800 transition-colors duration-200">
                        <strong className="transition-colors duration-200 hover:text-blue-900">You must define your own problem statement in the description below.</strong> 
                      </p>
                    </div>
                  )}
                  <Textarea
                    ...
                    placeholder={
                      user?.track === 'corporate'
                        ? "Problem Statement: [Clearly describe the specific problem or challenge your project addresses]\n\nProject Description: [Describe your solution, technologies used, and any other relevant details...]"
                        : "Describe your project, the problem it solves, technologies used, and any special features..."
                    }
                    rows={user?.track === 'corporate' ? 8 : 6}
                  ...
                  {user?.track !== 'corporate' && (
                    <p className="text-sm text-muted-foreground">
                      Describe how your project addresses the selected problem statement, the technologies used, and key features.
                    </p>
                  )}
                </div>
                    ...
                    <div className="mb-4 animate-in fade-in-50 slide-in-from-bottom-4 duration-300">
                      ...
                      <div className="mt-3 p-3 bg-blue-50/50 border border-blue-200/50 rounded-md transition-all duration-300 hover:bg-blue-100/50 hover:border-blue-300/50 hover:shadow-sm">
                        ...
                        <p className="text-xs text-blue-700 transition-colors duration-200">
                          • Code files must be uploaded here (links alone are not enough)
                        </p>
                        <p className="text-xs text-blue-700 transition-colors duration-200">
                ...
                <div className="bg-muted/50 p-4 rounded-md space-y-2 mb-4">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                    ...
                    <li>Please contact the committee on <a href="https://discord.gg/cNBzRBSr" className="underline font-medium">Discord</a> if you have any issues with submission</li>
                  </ul>
                </div>
