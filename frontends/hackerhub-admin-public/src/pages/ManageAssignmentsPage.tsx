...
const ManageAssignmentsPage = memo(() => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const [assignmentsRes, judgesRes, teamsRes, stagesRes] = await Promise.all([
        axios.get(`${API_GATEWAY_BASE_URL}/hackathons/${currentHackathonId}/admin/assignments`, { headers: { 'Authorization': `Bearer ${idToken}` } }),
        axios.get(`${API_GATEWAY_BASE_URL}/hackathons/${currentHackathonId}/admin/judges`, { headers: { 'Authorization': `Bearer ${idToken}` } }),
        axios.get(`${API_GATEWAY_BASE_URL}/hackathons/${currentHackathonId}/admin/teams`, { headers: { 'Authorization': `Bearer ${idToken}` } }),
        axios.get(`${API_GATEWAY_BASE_URL}/hackathons/${currentHackathonId}/admin/judging-stages`, { headers: { 'Authorization': `Bearer ${idToken}` } }),
      ]);
  ...
  const handleAddAssignment = async () => {
    ...
    try {
      await axios.post(`${API_GATEWAY_BASE_URL}/hackathons/${currentHackathonId}/admin/assignments`, formState, {
      ...
      bulkFormState.judgeIds.forEach(judgeId => {
        teamsToAssign.forEach(teamId => {
          assignmentPromises.push(
            axios.post(`${API_GATEWAY_BASE_URL}/hackathons/${currentHackathonId}/admin/assignments`, {
              judgeId: judgeId,
              teamId: teamId,
  ...
  const handleDeleteAssignment = async (assignmentId: string) => {
    ...
    setLoading(true);
    try {
      await axios.delete(`${API_GATEWAY_BASE_URL}/hackathons/${currentHackathonId}/admin/assignments/${assignmentId}`, {
  ...
  const handleBulkDelete = async () => {
    ...
    try {
        ...
        axios.delete(`${API_GATEWAY_BASE_URL}/hackathons/${currentHackathonId}/admin/assignments/${assignmentId}`, {
          headers: { 'Authorization': `Bearer ${idToken}` },
        })
      );
  ...
  useEffect(() => { if (idToken && currentHackathonId) fetchData(); }, [idToken, currentHackathonId, fetchData]);
