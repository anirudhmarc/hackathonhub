...
const NotFound: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-orange-50 text-gray-800 p-4">
      {/* AWS Logo */}
      <div className="mb-8">
      ...
      <div className="text-center max-w-lg">
        ...
        <div className="mt-8 text-xs text-gray-400">
          <p>Great Malaysia AI Hackathon • HackHub Portal</p>
        </div>
      </div>
    </div>
  );
